...
{?>							
		<div class="col-sm-6 col-md-4 wow fadeInUp">
			<div style="background: rgb(0,0,0);" class="products">				
	<div class="product">		
		<div class="product-image">
			<div style="padding:10px;" class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['productImage1']);?>" alt="" width="242.48" height="242.48"></a>
			</div><!-- /.image -->			                      		   
		</div><!-- /.product-image -->
			
		
		<div style="padding:10px; height:135px;" class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					...
					<div style="padding:10px;" class="cart clearfix animate-effect">
				<div class="action">
