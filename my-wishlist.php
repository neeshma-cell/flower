...
<div class="body-content outer-top-bd">
	...
	<div class="table-responsive">
		<table class="table">
			<thead>
				<tr>
					<th style="color:white;" colspan="4">my wishlist</th>
				</tr>
			</thead>
			<tbody>
<?php
...
?>
				...
				<tr style="background:black;">
					<td class="col-md-2"><img src="admin/productimages/<?php echo htmlentities($row['pimage']);?>" alt="<?php echo htmlentities($row['pname']);?>" width="150" height="150"></td>
					<td class="col-md-6">
