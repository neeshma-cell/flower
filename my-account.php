...
<div  class="panel panel-default checkout-step-01">
	...
	<div style="background:black;" id="collapseOne" class="panel-collapse collapse in">

		<!-- panel-body  -->
	    <div class="panel-body">
			<div class="row">		
<h4 style="color:rgb(150,150,150);"><u>Personal info:</u></h4>
...
<!-- checkout-step-01  -->
					    <!-- checkout-step-02  -->
					  	<div class="panel panel-default checkout-step-02">
						    <div style="background:black;" class="panel-heading">
						      <h4 class="unicase-checkout-title">
						        <a style="color:white;" data-toggle="collapse" class="collapsed" data-parent="#accordion" href="#collapseTwo">
						          <span>2</span>Change Password
						        </a>
						      </h4>
						    </div>
						    <div id="collapseTwo" class="panel-collapse collapse">
						      <div style="background:black;" class="panel-body">
